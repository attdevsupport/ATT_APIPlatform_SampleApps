...
This file describes how to set up, configure and run the C#.NET Applications of the
AT&T MSSDK C#.NET sample applications. It covers all steps required to register 
the application on https://developer.att.com/ and, based on the generated API keys and secrets, 
