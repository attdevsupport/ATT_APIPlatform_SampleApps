...
public partial class Ad_App1 : System.Web.UI.Page
{
    ...
    private void GetAds()
    {
        try
        {
            ...
            AdResponse adsResponse = this.requestFactory.GetAdvertisement(adsRequest, this.psedoZone);
        ...
        catch (ArgumentException ae)
        {
            this.DrawPanelForFailure(statusPanel, ae.Message);
            /*
            string[] errorMessages = ae.Message.ToString().Split(new Char[] { ' ' });
    ...
    private AdRequest BuildAdRequestObject()
    {
        ...
        {
            adsRequest.Type += Convert.ToUInt32( this.AdType);
        }
