<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="WapPush_App1" %>
...
<body>
    ...
    <div id="container">
        ...
        <br clear="all" />
        <div align="center">
            <asp:Panel ID="wapPanel" runat="server" Font-Names="Calibri" HorizontalAlign="Left">
            </asp:Panel>
        </div>
