...
DevConnect and, based on the generated API keys and secrets, create and 
run one's own full-fledged sample applications.
...
4) phoneNumbers			: This is mandatory key, which specifies the registered phone numbers 
