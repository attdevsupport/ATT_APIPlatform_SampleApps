...
if (typeof numberToDial === 'undefined')
{
    ...
    var result24 = ask("Press  ten digit phone number for which you are calling to rejected this call or Press pound to skip", {
        choices: "[10 DIGITS]",
        terminator: "#",
        timeout: 120.0,
        mode: "dtmf",
    ...
    if ( result24.value != "")
    {
        ...
        {
            say("number not matched for rejecting feature");
    ...
    var result27 = ask("Press  ten digit phone number for which you are calling to waited this call or Press pound to skip", {
    choices: "[10 DIGITS]",
    terminator: "#",
    timeout: 120.0,
    mode: "dtmf",
...
else
{
	...
	case 'reject':
          ...
          else
          {
               ...
               if (callerID == featurenumber) {
                ...
                {
                    say("present id is");
                    say("<speak><say-as interpret-as = 'vxml:digits'>" + currentCall.callerID + "</say-as></speak>");
                    say("rejectnumber is ")
                    say("<speak><say-as interpret-as = 'vxml:digits'>" + featurenumber + "</say-as></speak>");
    ...
    {
        say("messageToPlay is not provided as part of create session A P I request and hence you may not able to test signals properly");
    }
