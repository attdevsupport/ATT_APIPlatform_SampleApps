<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="MOBO_App1" %>
        ...
        <div class="extra">
            ...
            <table>
                <tbody>
                    <tr>
                        <td>
                            <asp:Button runat="server" ID="btnSendMessage" Text="Send Message" OnClick="BtnSendMessage_Click" />
                        </td>
                    </tr>
                </tbody>
            </table>
