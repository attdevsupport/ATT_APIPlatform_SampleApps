<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="TL_App1" %>
...
<body>
    ...
    <div id="container">
        ...
        <div class="extra">
            ...
            <br />
            <br />
            <asp:Button ID="GetDeviceLocationButton" runat="server" Text="Get Phone Location"
                OnClick="GetDeviceLocation_Click" />
        </div>
        <br clear="all" />
        <div>
