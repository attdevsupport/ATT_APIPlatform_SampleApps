...
public class ConfigBean implements Serializable {
    ...
    public String getPollMsgsShortCode() throws IOException {
        return getConfig().getProperty("getMsgsShortCode");
    }

    public String getReceiveMsgsShortCode() throws IOException {
        return getConfig().getProperty("receiveMsgsShortCode");
    }
}
