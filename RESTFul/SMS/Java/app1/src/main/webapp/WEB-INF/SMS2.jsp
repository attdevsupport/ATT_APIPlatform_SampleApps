    ...
    <div id="pageContainer">
      <div id="header">
        ...
        <ul class="links" id="nav">
          ...
          <li>
            <a href="${cfg.linkSource}" target="_blank">Source<img alt="source" src="images/opensource.png" /></a>
            <span class="divider"> |&nbsp;</span>
          </li>
          <li>
            <a href="${cfg.linkDownload}" target="_blank">Download<img alt="download" src="images/download.png"></a>
            <span class="divider"> |&nbsp;</span>
          </li>
          <li>
            ...
            <div class="inputFields">
              <div id="sendSMSdiv">
                ...
                <div class="successWide">
                  ...
                  <strong>Message Id: </strong>${requestScope.sendId}<br>
                </div>
                </c:if>
              </div> <!-- end of sendSMS -->
              ...
              <div id="getStatusdiv">
                ...
                <form method="post" action="getStatus" name="getStatusForm" id="getStatusForm">
                  ...
                  <input placeholder="Message ID" name="messageId" id="messageId" type="text" 
                    value="${requestScope.sendId}">
                  </c:if>
                  <c:if test="${empty requestScope.sendId}">
                  <input placeholder="Message ID" name="messageId" id="messageId" type="text">
                  </c:if>
