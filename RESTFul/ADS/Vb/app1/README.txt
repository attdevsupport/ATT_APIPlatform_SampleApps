...
4) scope		: ADS(Scope of the ATT service that will be invoked by the
			  Application)
...
6) udid			: The UDID Parameter is used for ad tracking purpose and 
			  should be atleast 30 characters 

7) Psedo_zone		: This parameter specifies the mapping between API Gateway 
			  and south bound enabler.

8) refreshTokenExpiresIn: This is optional key, which specifies the expiry time of refresh 
