...
NOTE: You MUST select Advertising in the list of services under field 'Services' in order to use this sample application code. 
...
4. Running the application
  ...
  in a web browser, so you may visit: http://localhost:8080/SampleApp/ADS.jsp to see it working.
