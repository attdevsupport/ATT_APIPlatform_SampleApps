...
3. Parameters
  ...
  4) scriptPath                         : location of scripts. default: /scripts/

  5) sessionEndPoint                    : FQDN + "/rest/1/Sessions"

  6) signalEndPoint                     : FQDN + "/rest/1/Sessions/{sessionid}/Signals"

  7) phoneNumber			      : Application's test phone number
...
4. Running the application
  ...
  in a web browser, so you may visit: http://localhost:8080/SampleApp/CMS.jsp to see it working.
