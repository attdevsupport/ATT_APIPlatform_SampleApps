                ...
                <div id="formContainer" class="formContainer">
                    <div id="sendMessages">
                        ...
                        <div class="inputFields">
                            ...
                            <label>
                                ...
                                <input name="txtNumber" id="txtNumber" runat="server" value="" placeholder="Number"
                            ...
                            <input type="text" style="display: inline" name="txtMessageToPlay" value="" placeholder="Message"
                                title="enter long message or mp3 audio url, this is used as music on hold" id="txtMessageToPlay"
                                runat="server" />
                            <div id="scriptText">
                                <label>
                                    Script Source Code:
                            ...
                            <% if (!string.IsNullOrEmpty(successOfCreateSessionResponse))
                               { %>
                            ...
                            <% } %>
                            <% if (!string.IsNullOrEmpty(createSessionErrorResponse))
                               { %>
                            <div class="errorWide">
                    ...
                    <div id="sendSignal">
                        ...
                        <div class="inputFields">
                            ...
                            <% if (!string.IsNullOrEmpty(statusOfSendSignalResponse))
                               { %>
                            <div class="successWide">
                                <strong>SUCCESS:</strong>
                                <br />
                            ...
                            <% } %>
                            <% if (!string.IsNullOrEmpty(sendSignalErrorResponse))
                               { %>
                            <div class="errorWide">
                                <strong>ERROR:</strong><br />
