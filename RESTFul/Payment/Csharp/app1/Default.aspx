...
<body onload="setup()">
    <form id="form1" runat="server">
                    ...
                    <textarea id="payload" name="payload" placeholder="Payload" runat="server"></textarea>
                        ...
                        <div class="toggle" id="notification">
                            ...
                            <% int count = 1;
                               ...
                               { %>
                            <h2>Notification: <%= count %> <% if(count == 1) { %> [ Displays last 5 notifications ]  <% } %></h2>
                            <table class="kvp" id="Table1">
                                <tbody>
                                    <%   foreach (var pair in notificationDetail)
                                         { %>
                                    <tr>
                                        <td data-value="Parameter">
                                            <%= pair.Key.ToString()%>
                         ...
                         <% } %>
                            ...
                            <button type="submit" name="refreshNotifications" runat="server" onserverclick="ShowNotifications_Click">Refresh</button>
                        </div>
        ...
        <% } %>
         <% if (!string.IsNullOrEmpty(showNotification))
           { %>
