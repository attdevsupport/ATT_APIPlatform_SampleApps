    ...
    module Model
      ...
      class Capabilities
        ...
        def each
          ...
          yield "Vendor", @vendor
          yield "Model", @model
          yield "FirmwareVersion", @firmware_version
          yield "UaProf", @uaprof
          yield "MmsCapable", @mms_capable
          yield "AssistedGps", @assisted_gps
          yield "LocationTechnology", @location_technology
          yield "DeviceBrowser", @device_browser
          yield "WapPushCapable", @wap_push_capable
        end
