...
public class DeleteGroupController extends APIController {

    private static final long serialVersionUID = -7247608815243870978L;
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            final String gid = request.getParameter("deleteGroupId");
            srvc.deleteGroup(gid);
            jresponse.put("success", true)
                      .put("text", "Successfully deleted group.");
        } catch (Exception e) {
