...
public class RemoveContactsFromGroupController extends APIController {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            final String gid = request.getParameter("removeContactsGroupId");
            if (gid.equals("")) {
                throw new IllegalArgumentException("Group id must not be empty");
            }
            final String cids = request.getParameter("removeContactIds");
            if (cids.equals("")) {
                throw new IllegalArgumentException("Contact ids must not be empty");
            }
            srvc.removeContactsFromGroup(gid, cids);
            jresponse.put("success", true)
                     .put("text", "Successfully removed contacts from group");
        } catch (Exception e) {
