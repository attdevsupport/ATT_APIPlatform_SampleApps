...
public class CreateGroupController extends APIController {

    private static final long serialVersionUID = -2955459153841498116L;
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            final String gname = request.getParameter("createGroupName");
            final Group group = new Group(gname);
            final String location  = srvc.createGroup(group);
