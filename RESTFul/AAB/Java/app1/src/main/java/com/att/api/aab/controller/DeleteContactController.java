...
public class DeleteContactController extends APIController {

    private static final long serialVersionUID = 5039432169581960462L;
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            final String contactId = request.getParameter("deleteContactId");
            srvc.deleteContact(contactId);
            jresponse.put("success", true)
                     .put("text", "Successfully deleted contact.");
        } catch (Exception e) {
