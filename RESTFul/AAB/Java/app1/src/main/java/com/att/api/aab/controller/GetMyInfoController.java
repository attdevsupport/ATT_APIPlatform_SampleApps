...
public class GetMyInfoController extends APIController {

    private static final long serialVersionUID = -4017289005649381913L;
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            final Contact contact = srvc.getMyInfo();
