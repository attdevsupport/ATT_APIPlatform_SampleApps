...
The application allows an AT&T subscriber to retrieve device specific information 
about the mobile device.

This file describes how to set up, configure and run the Java Application of the
...
1) client_id                          : set the value as per your registered application 'API key' field value

2) secret_key                         : set the value as per your registered application 'Secret key' field value 

3) FQDN                               : https://api.att.com

4) getdc_url                          : /rest/2/Devices/Info

5) endpoint                           : FQDN + getdc_url

6) redirectURL                        : application redirect URL. OAUTH will redirect to this URL. The value must match
                                        the provisioned value by the App. 
