...
public class TextToSpeechController extends APIController {
    ...
    public void doPost(HttpServletRequest request,
        ...
        try {
            ...
            final TtsService srvc = 
                new TtsService(appConfig.getApiFQDN(), token);
            ...
            final byte[] wavBytes 
                = srvc.sendRequest(contentType, speechText, xArg);

            JSONObject jaudio = new JSONObject()
                .put("type", "audio/wav")
