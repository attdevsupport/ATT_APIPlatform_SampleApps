                ...
                <div id="formContainer" class="formContainer">
                    <div id="sendMMS">
                        ...
                        <div class="inputFields">
                            ...
                            <button id="sendMms" type="submit" class="submit" onserverclick="SendMessage_Click" runat="server"
                                name="sendMms">
                    ...
                    <!-- end of sendMMS -->
                    <% If Not String.IsNullOrEmpty(sendMessageResponseError) Then
                       %>
                    <div class="errorWide">
                        <strong>ERROR: </strong>
                        <br />
                    ...
                    <% End If%>
                    <% If Not String.IsNullOrEmpty(sendMessageResponseSuccess) Then%>
                    <div class="successWide">
                        <strong>SUCCESS:</strong><br />
                        <strong>messageId: </strong>
                        <%= sendMMSResponseData.outboundMessageResponse.messageId%>
                        <% If sendMMSResponseData.outboundMessageResponse.resourceReference IsNot Nothing Then%>
                        <br />
                    ...
                    <% If Not String.IsNullOrEmpty(getDeliveryStatusResponseError) Then
                       %>
                    <div class="errorWide">
                        <strong>ERROR: </strong>
                        <br />
                    ...
                    <%End If%>
                    <% If Not String.IsNullOrEmpty(getDeliveryStatusResponseSuccess) Then
                       %>
                            <div class="successWide">
                            ...
                            <table>
                                ...
                                <tbody>
                                    <% For Each delinfo In getMMSDeliveryStatusResponseData.DeliveryInfoList.DeliveryInfo
                                       %>
                                    <tr>
                                        <td data-value="Id">
                                            <%=delinfo.Id %>
                    ...
                    <%End If%>
                        ...
                        <div id="receiveStatusdiv">
                            ...
                            <% If receiveMMSDeliveryStatusResponseData IsNot Nothing AndAlso receiveMMSDeliveryStatusResponseData.Count > 0 Then
                               %>
                                    <tbody>
                                        <% For Each deinfo In receiveMMSDeliveryStatusResponseData
                                           %>
                                        <tr>
